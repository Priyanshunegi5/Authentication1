                  ...
                  <div className="md:mx-6 md:p-12">
                    ...
                    <div className="text-center">
                      <img
                        ...
                        src="https://dovelp.com/wp-content/uploads/2022/05/Dovelp-full-Final-ai.svg"
                        alt="logo" className="w"
                      />
                      <h4 className="mb-12 mt-1 pb-1 text-xl font-semibold">
                        We are The Dovelp Team
                      </h4>
                    </div>
                ...
                >
                  <div className="px-4 py-6 text-white md:mx-6 md:p-12">
                    <h4 className="mb-6 text-xl font-semibold">
                      wonder land of technology
                    </h4>
                    <p className="text-sm">
                      Empowering startups through innovative IT solutions;
                      We Build, You Thrive!
